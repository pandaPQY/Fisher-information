\begin{section}{Reconstruction Technique}
  ...
  \tcr{This reconstruction technique is called {\it isopotential mass coordinates} (IMC) method for 
  mass density and thus $\phi$ is uniform in the target curvilinear coordinates.}
