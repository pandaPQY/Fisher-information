...
This includes the decorrelation between initial and final fields,
which has been neglected in many previous studies, and we find
that the log-normal transform in this metric only gains a factor
of 4 in information.
