...
the logarithmic density mapping method \cite{bib:Mark2009} as an example to illustrate its strength. 
...
for better comparison. We find that, in this case, the nonlinear information drops from the linear one beginning at the same scale, 
...
per volume given by setting the cross correlation to be unity. The black, blue and cyan lines match the results in 
