\begin{section}{Fisher Information Content}
  ...
  \tcr{Mathematically}, the Fisher information $I$ of the initial scale
  ...
  regime, $k \lesssim 0.07$ $h$ \tcr{Mpc$^{-1}$}.  The off-diagonal
  ...
  $h$ \tcr{Mpc$^{-1}$}.  However, the number and magnitude of negative off-diagonal elements
  ...
  $k \simeq 0.05$ $h$ \tcr{Mpc$^{-1}$}, and has a flat plateau on small scales, 
  ...
  until $k\simeq 0.3$ $h$ \tcr{Mpc$^{-1}$}, and reaches a value of 
  $I \simeq 1.3 \times 10^{-3}/($\tcr{Mpc} $h^{-1})^3$ at $k \simeq 2.7$ $h$ \tcr{Mpc$^{-1}$},
  a factor of 50 times greater than $I_{\delta_\mathrm{\tcr{N}}}$.
  As an example to illustrate its strength, we compare the Fisher information given by the \tcr{PI} reconstruction method
  with the logarithmic density mapping method \citep{bib:Mark2009}. We find that \tcr{PI}
  ...
  To test the upper limit of information that the \tcr{PI} reconstruction can recover, 
  ...
  We find that $I_{\delta_\mathrm{\tcr{E}}}$ is \tcr{three} times higher ($150 I_{\delta_\mathrm{\tcr{N}}}$) than \tcr{PI} reconstruction.
  ...
  increase in information on small scales ($k\gtrsim 1 h$ \tcr{Mpc$^{-1}$}).  We also see that 
  ...
  Practically, we use $I_{\delta_{\alpha}}$ ($k=2.7 h$ \tcr{Mpc}$^{-1}$)
  ...
  We find that
  for $\delta_\mathrm{\tcr{N}}$, $k\tcr{_\mathrm{p}}\simeq 0.15$ $h$ \tcr{Mpc$^{-1}$}.
  The \tcr{PI} reconstruction increases $k\tcr{_\mathrm{p}}$ to $0.4$ $h$ \tcr{Mpc$^{-1}$},
  whereas the logarithmic density mapping method only increases it to $0.19$ $h$ \tcr{Mpc$^{-1}$}.
  ...
  \begin{figure*}
    ...
    \caption{{\it Left.} The Fisher information (thick curves) per unit volume as
      a function of \tcr{wavenumber}.  The blue solid, red dashed, and black dash-dotted curves correspond to the power spectra
      ...
      are the cumulative number of $k$ modes.  Thin dotted horizontal lines indicate the value of the 
       Fisher information at $k \simeq 2.7$ $h$ \tcr{Mpc$^{-1}$}.  {\it Right.} Same
