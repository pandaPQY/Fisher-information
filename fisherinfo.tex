\begin{section}{Fisher Information Content}
  ...
  \tcb{To test the upper limit of information that the MM reconstruction can recover, 
  ...
  % comment: Moving-mesh is positive definite and cannot include shell-crossing.
  % other possible reconstruction techniques (e.g. least action) may take shell-crossing into
  % account, and might bring the quality closer to E-mode.
  % that's why I delete the word "MM".
  ...
  \tcb{In the context of BAO analysis and extracting other primordial cosmological
  ...
  % also eliminates the second increase of the information on small scales, which 
  ...
  \tcb{Practically, we use $I_{\delta_{\alpha}}$ ($k=2.7$ $h$/Mpc)
  ...
  \tcr{Practically, we take $I_{\delta_{\alpha}}(k\rightarrow\infty)$ to be
  $I_{\delta_{\alpha}}$ ($k=2.7$ $h$/Mpc) where $r$ goes down to zero already.}
  We find that
