\begin{section}{Fisher Information Content}
  ...
  As an example to illustrate its strength, we compare the Fisher information given by the IMC reconstruction method
  with the logarithmic density mapping method \citep{bib:Mark2009}. We find that IMC
  ...
  To test the upper limit of information that the IMC reconstruction can recover, 
  ...
  We find that $I_{\delta_E}$ is 3 times higher ($150 I_{\delta_N}$) than IMC reconstruction.
  ...
  The IMC reconstruction increases $k_p$ to $0.4$ $h$/Mpc,
