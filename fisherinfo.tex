\begin{section}{Fisher Information Content}
  ...
  power spectra is equal to the number of $k$-modes \tcr {within the shell in 
  Fourier space, $N_k$}. As expected, Fisher information of
  ...
  \tcr{This gives strong motivation to continue to develop and optimize our 
  reconstruction algorithms to achieve this theoretical target.}
  
  \tcb{Again, from our yesterday's Wechat telecon,
  I don't see this motivation strong.\\
  (i) 50 or 150 times more information is
  ...
  is via the information plateau's linear equivalent scale, $k_{\rm LEq}$, satisfying
  \begin{equation}
      I_{\delta_L}(k_{\rm LEq})=I_{\delta_{\alpha}}(k\rightarrow\infty).
  \end{equation}
  \tcr{[I don't like the subscript LEq, very strange.]}
  In the left panel of Fig. \ref{fig:fisherinfo}, we can see that 
  $k_{\rm LEq}$ is just the scale on which 
