\begin{section}{Fisher Information Content}
  ...
  As an example to illustrate its strength, we compare the Fisher information given by the \tcr{IMC} reconstruction method
  with the logarithmic density mapping method \citep{bib:Mark2009}. We find that \tcr{IMC}
  ...
  To test the upper limit of information that the \tcr{IMC} reconstruction can recover, 
  ...
  We find that $I_{\delta_E}$ is 3 times higher ($150 I_{\delta_N}$) than \tcr{IMC} reconstruction.
  ...
  increase in information on small scales ($k\gtrsim 1 h/\mathrm{Mpc}$).  We also see that 
  ...
  The \tcr{IMC} reconstruction increases $k_p$ to $0.4$ $h$/Mpc,
