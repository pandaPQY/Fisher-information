\begin{section}{Introduction}\label{sec:introduction}  
  ...
  {\it Reconstruction} techniques \tcr{\citep{bib:Eisenstein2007}} provide a more
  ...
  ($k \simeq 0.2-0.8$ $h$ \tcr{Mpc$^{-1}$}) due to strong coupling between Fourier
  ...
  In studies of \tcr{baryon acoustic oscillations} (BAO), density fields are
  subjected to reconstruction \tcr{that} partially inverts nonlinear
  evolution by applying the negative Zel'dovich displacement field \citep{bib:Eisenstein2007,bib:Zel1970}.
  \citet{bib:Yu2016} studied the curl-free, or \tcr{E}-mode, component of 
  the exact displacement field in Lagrangian
  space and found that the linear density field can be well recovered by
  the \tcr{E}-mode displacement field.
  This \tcr{E}-mode reconstruction therefore provides a theoretical 
  ...
  fields.  \tcr{This} paper is organized as follows.  In \S
  \ref{sec:reconstruction}, we briefly
  describe the computation of the displacement potential using \tcr{potential isobaric 
  reconstruction (PI) method}.
