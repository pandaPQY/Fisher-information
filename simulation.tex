\begin{section}{Implementation and Power Spectra}
 ...
 We use the \tcr {Voronoi tessellation method \cite{bib:Van1994}} to estimate the density contrast
 ...
 until the \tcr{root mean square (rms) of the results} drop from $\sim 7.5$
