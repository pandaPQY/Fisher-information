\begin{section}{Implementation and Power Spectra}
  ...
  % and then propagating the power
  %back to 
  at $z=100$.
  %with a linear growth factor.
  Zel'dovich
 ...
 We use the Voronoi tessellation method \tcr{[add citation in .bib]} \cite{bib:Van1994} to estimate the density contrast
 ...
 spectrum of \tcr{linear theory density fields} $\delta_L$, nonlinear density
