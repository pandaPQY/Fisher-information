\begin{section}{Implementation and Power Spectra}
  ...
  \begin{figure*}
    ...
    \caption{ Illustration of \tcr{IMC} reconstruction.
 ...
 \tcr{IMC} reconstruction to these fields with $512^3$ grids.
 ...
 Even though $r_{RL}$ decreases from $r_{EL}$ in the nonlinear regime due to the fact that the \tcr{IMC} reconstruction 
 ...
 wave numbers, which we attribute to using fewer particles per simulation.
  ...
  \begin{figure*}
    ...
    \caption{{\it Left.} The dimensionless power spectrum computed via
      ...
      \tcr{IMC} reconstructed and linear densities $r_{RL}$ (red dashed line), and E-mode reconstruction $r_{EL}$ (cyan dotted line) from \citealt{bib:Yu2016}.}
    \label{fig:cp}
  \end{figure*}
