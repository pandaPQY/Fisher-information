\begin{section}{Implementation and Power Spectra}
 ...
 Even though $r_{RL}$ decreases from $r_{EL}$ in the nonlinear regime due to the fact that the \tcr{PI} reconstruction 
 ...
 wave numbers, which we attribute to using fewer particles per simulation.
  ...
  \begin{figure*}
    ...
    \caption{{\it Left.} The dimensionless power spectrum computed via
      ...
      \tcr{PI} reconstructed and linear densities $r_{RL}$ (red dashed line), and E-mode reconstruction $r_{EL}$ (cyan dotted line) from \citealt{bib:Yu2016}.}
    \label{fig:cp}
  \end{figure*}
