...
\begin{figure*}[t!]
\centering
% \includegraphics[width=0.8\textwidth]{simulationlog-crop.pdf}
...
%\end{tabular}
 \label{fig:simandrec}
   \caption{
%(a) Map of a randomly selected $\mathrm{log}(\delta +1)$ field from 136 N-body simulations, with a 300 $h^{-1}$Mpc width box and $1024^3$ pixels. It's one layer of the whole box field, and the magnitude is the average of number of particles per cell.(b) 
