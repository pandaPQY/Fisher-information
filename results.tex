\begin{section}{Conclusion}
  ...
  We study the \tcr{Isopotential Mass Coordinates (IMC) method}'s ability to estimate the underlying displacement 
  ...
  techniques.
We find that \tcr{IMC} method gives better results than previous works
  ...
  \tcr{The advantage of this method is that it doesn't include cosmological dynamics and thus 
